...
// Extracted from email.service.ts for maintainability.
// Each function returns a self-contained HTML email string.
// ──────────────────────────────────────────────

export function passwordResetEmailHtml(resetUrl: string, displayName: string): string {
  return `
<!DOCTYPE html>
<html>
<head>
...
export function emailVerificationHtml(verifyUrl: string, displayName: string): string {
  return `
<!DOCTYPE html>
<html>
<head>
...
export function projectInviteHtml(inviteUrl: string, inviterName: string, projectName: string, recipientName: string): string {
  return `
<!DOCTYPE html>
<html>
<head>
...
export function taskAssignmentHtml(taskUrl: string, assignerName: string, taskTitle: string, projectName: string, recipientName: string): string {
  return `
<!DOCTYPE html>
<html>
<head>
...
export function taskUpdatedHtml(taskUrl: string, updaterName: string, taskTitle: string, projectName: string, recipientName: string): string {
  return `
<!DOCTYPE html>
<html>
<head>
...
export function taskCommentedHtml(taskUrl: string, commenterName: string, taskTitle: string, projectName: string, recipientName: string, commentPreview: string): string {
  return `
<!DOCTYPE html>
<html>
<head>
...
export function dueDateReminderHtml(taskUrl: string, taskTitle: string, projectName: string, recipientName: string, dueDate: string): string {
  return `
<!DOCTYPE html>
<html>
<head>
