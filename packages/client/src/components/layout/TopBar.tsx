...
const DropdownItem: React.FC<{
  ...
  <button
    onClick={onClick}
    className="flex items-center gap-2 w-full px-2.5 py-2 border-none rounded-lg text-[13px] font-medium cursor-pointer text-left bg-transparent transition-colors duration-200"
    ...
    onMouseEnter={e => {
      ...
      e.currentTarget.style.color = danger ? 'var(--color-danger-text)' : 'var(--color-text-primary)';
    }}
    onMouseLeave={e => {
